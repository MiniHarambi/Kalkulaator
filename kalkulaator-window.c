...
static void bitSetButton__clicked(GtkButton *data, gpointer user_data);
static void bitClearButton__clicked(GtkButton *data, gpointer user_data);
static void bitToggleButton__clicked(GtkButton *data, gpointer user_data);
static void bitReadButton__clicked(GtkButton *data, gpointer user_data);
...
static void bitSetButton__clicked(GtkButton *data, gpointer user_data)
{
  ...
  const gchar *text = binary_str;
  int bit = atoi(bit_str);
  gchar *result = MaskOptions(button, text, bit);
  g_print("%s", result);
  gtk_editable_set_text(GTK_EDITABLE(result_entry), result);
...
static void bitClearButton__clicked(GtkButton *data, gpointer user_data)
{
  ...
  const gchar *text = binary_str;
  int bit = atoi(bit_str);
  const gchar *result = MaskOptions(button, text, bit);
  g_print("%s", result);
  gtk_editable_set_text(GTK_EDITABLE(result_entry), result);
